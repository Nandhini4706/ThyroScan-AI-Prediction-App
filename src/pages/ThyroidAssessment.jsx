...
export default function ThyroidAssessment() {
    ...
    Logout
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-3">
              ...
              <FeaturePill icon={RiHeartPulseLine} text="Personalised advice" />
            </div>
          </div>
          ...
          <div className="flex-1 w-full max-w-xs">
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-2">
              ...
              <StatPill icon={RiHeartPulseLine} value="24/7" label="Available" color="bg-emerald-100 text-emerald-700" />
            </div>
          </div>
        </div>
